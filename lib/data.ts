...
export const oneExerciseContent: Feature[] = [
  {
    name: 'Intro',
    description: `Hey there, my name is Mostafa Lotfy, an indie app maker. I used to track my workouts manually or through different apps that provided basic history.
    \nI like to start slowl and build up my progress, reviewing each workout to see how many reps or how much weight I used previously.
    \nSo, I created a minimal workout tracker, OneExercise, that gives instant feedback for each set, while also providing quick access to the full history and some additional simple stats. This way, I can focus on improving one of these stats with each workout.
  ...
  },
  {
    ...
    src: '/addNewExercise_extraCompressed.mp4'
  },
  {
