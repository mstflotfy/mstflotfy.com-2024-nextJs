export const metadata = {
  title: 'About Mostafa Lotfy',
  description: 'I am an indie app developer exploring and building tools for productivity',
  alternates: {
    canonical: 'https://mstflotfy.com/about', // Set your canonical URL here
  }
};
