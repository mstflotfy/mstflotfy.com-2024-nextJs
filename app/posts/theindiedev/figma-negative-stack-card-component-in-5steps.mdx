...
image: /images/posts/v15/figma-negative-stacked-card-component-indieDev-mstflotfy.png
date: "2022-06-18"
categories: ['design']
tags: ['figma', 'tutorial']
---
...
<small>
	...
	<a
	src="https://www.youtube.com/c/mstflotfyindieDev"
	target="_blank"
	rel="noopener"
	>YouTube</a>
</small>
...
<small>
	<CustomLink href="https://www.figma.com/community/file/1119848425895842486">Here's the final Figma file</CustomLink>.
</small>
...
<a
	href="https://www.youtube.com/playlist?list=PLsOexrcoU3Q4b-dI6chgagDntDD-AgetO"
	target="_blank"
	rel="noreferrer"
>
...
![2 screenshots of multiple cards with text below them, inside a Figma file.](/images/posts/v15/pinterest-component-screenshots.png)
...
![right clicking on the card stack and selecting Inspect from the menu](/images/posts/v15/inspect-image.png)

All you need to do is head to your browser, **right-click**, and select **"Inspect"**

![Page is split between code and Pinterest's board page](/images/posts/v15/inspect-code.png)
...
![Label above image that shows size](/images/posts/v15/inspect-image-size.png)

**Hover** above the **first image** in the stack and its **size** will show up **above it (116px * 155px)**.

![css code showing the image has a border-radius of 16px](/images/posts/v15/inspect-border-radius.png)
...
![Pinterest's board page. image stack's code is selected and its dimension are shown (236*157px)](/images/posts/v15/inspect-stack-properties.png)
...
![whole component code inspected](/images/posts/v15/inspect-component-properties.png)

Then get the width and height of the **full component(236 * 215 px)**.

![Main text inspected](/images/posts/v15/inspect-h2-text-properties.png)

Finally, select the main text and get its **font size (20px)**.

![inspector open and hovering above text](/images/posts/v15/inspect-.png)

And the font size of the secondary text **(12px)**.

![hovering above icon while the inspector is open and dimensions are shown](/images/posts/v15/inspect-icon-size.png)

One last thing we need to grab is the dimensions of the lock icon (**32 * 32 px**).

![Inspector code on the right page on the left drop-down open with devices to select from](/images/posts/v15/toggle-device-inside-inspector.png)
...
Instead of going to <CustomLink href="https://unsplash.com/">Unsplash.com</CustomLink> searching for an image, downloading it, uploading it into Figma, then doing this for all the other images we'll need later, just <CustomLink href="https://www.figma.com/community/plugin/738454987945972471/Unsplash">install the Unsplash Figma plugin</CustomLink>.


![a search bar over the Figma canvas with Unsplash written in it](/images/posts/v15/open-unsplash-in-figma.png)
...
![Unsplash plugin hovering above figma's canvas and image dropped inside the canvas](/images/posts/v15/image-from-unsplash-in-figma.png)

Select any image and it will be dropped into your canvas.

## 4 Set Image Properties 

![Image zoomed-in, given rounded corners, width, and height](/images/posts/v15/image-width-height-radius.png)
...
![image wrapped in an auto-layout frame](/images/posts/v15/add-auto-layout-frame.png)
...
![auto layout padding removed. Frame wrapping around the image with no extra padding.](/images/posts/v15/remove-auto-layout-padding.png)

The auto-layout frame has padding by default, so remove it, by setting All paddings to <kbd>0px</kbd>.

![4 images inside an auto-layout frame](/images/posts/v15/add-images-to-auto-layout-frame.png)
...
![Unsplash plugin open and image changed](/images/posts/v15/change-images-from-unsplash.png)
...
![4 different images stacked on top of each other](/images/posts/v15/negative-stacked-images-auto-layout.png)
...
![image stacked on top of one another first on top from the left](/images/posts/v15/change-stack-order.png)
...
![Zoom in on card stack reference shows a white border around images](/images/posts/v15/pinterest-boards-image-border.png)
...
![image CSS shows a solid white border of 1px](/images/posts/v15/border-around-image.png)

Inspecting the code again, I found a property of the image that we missed. It has a 1px white border around it.

![4 negatively stacked images inside Figma each with a solid white stroke of 1px.](/images/posts/v15/add-stroke-to-image.png)
...
![inspecting the main text code in Pinterest shows a font-weight property that has a value of bold.](/images/posts/v15/inspect-main-text-font-weight.png)

The font-weight for the main text is bold.

![inspecting secondary text show it has a value of normal](/images/posts/v15/inspect-secondary-font-weight.png)

And the font weight for the secondary text is normal/regular.

![2 text box added in Figma under the image stack, but not in a frame with it. The main text is bold with 20px. Secondary text is regular with 12px. Both use a Roboto font.](/images/posts/v15/add-text-in-figma.png)
...
![Pinterest boards page with code inspector open. The div holding the text is highlighted and its dimensions are "236*50"](/images/posts/v15/inspect-div-holding-text.png)
...
![2 text boxes inside an auto-layout frame, aligned left, with 8px padding.](/images/posts/v15/auto-layout-all-text.png)
...
![auto-layout frame around cards frame and text frame, with no padding, and a height of 215px](/images/posts/v15/add-auto-layout-to-component.png)
...
![card is selected and hovering above Create component button](/images/posts/v15/turn-auto-layout-frame-to-component.png)

To turn the "card frame" into a component, select it and press the **create component** button at the top of the page.

![mouse hovering above the component icon in the layers panel, while the new component is selected.](/images/posts/v15/show-frame-as-component.png)
...
![All pin (main text) is selected and mouse hovering above Apply text property icon in the Design panel.](/images/posts/v15/add-text-component-property.png)
...
![Create component property pops up above the page. property is named: Text, with a value of All Pins. Mouse-hovering above the "create property" button.](/images/posts/v15/name-text-component-property.png)

You'll be prompted to give your new **component property** a **Name** and a **default Value**, after you do, click on **Create property**.

![secondary text (1, 851 Pins) is selected, create text property icon is clicked, a drop-down menu is shown, and pointer hovering above create property](/images/posts/v15/second-text-component-prperty.png)
...
![Pinterest boards page is shown. Code inspector is open on the right. SVG icon is selected to be copied.](/images/posts/v15/copy-icon-svg.png)
...
![svg icon pasted in Figma under the card component](/images/posts/v15/paste-icon-svg-in-figma.png)

Paste it inside your Figma File by pressing <kbd>cmd/ctrl v</kbd>.

![svg icon's frame turned into an auto-layout, and width and height are set to **fixed**.](/images/posts/v15/turn-icon-frame-to-auto-layout.png)
...
![Lock icon selected](/images/posts/v15/allign-icon-to-center.png)
...
![lock icon with white circular background](/images/posts/v15/give-icon-frame-layer.png)
...
In the **design panel**, **Frame**, give the frame a <kbd>100px</kbd> rounded corners, to turn it into a circle.

![lock icon inside the image stack frame and selected](/images/posts/v15/add-lock-icon-to-image-stack.png)
...
![Lock icon above the image stack and cursor hovering above absolute position.](/images/posts/v15/give-icon-relative-position.png)
...
![`margin-left: 16px;`](/images/posts/v15/inspect-icon-frame-code.png)

![`margin-top: 16px;`](/images/posts/v15/icon-frame-margin-top.png)
...
![icon above image stack with 16 px top and left between it and the frame](/images/posts/v15/align-icon-in-frame.png)

Translating this in Figma, just give the element an x and y positions of <kbd>16px</kbd> inside the images frame.

![icon selected and cursor hovering above Add boolean property icon](/images/posts/v15/add-boolean-property-in-figma.png)
...
![Create component property box pops above page to name property](/images/posts/v15/name-icon-boolean-property.png)
...
![frame tool selected and cursor hovering above MacBook 14" in the design panel.](/images/posts/v15/add-a-macbook-frame.png)

Click on the **frame tool** (top-left), then select one of the custom size frames from the "**design panel**". 

![2 instances of the component in a mac frame](/images/posts/v15/put-instances-in-frame.png)
...
![the second instance selected and component properties updated](/images/posts/v15/change-instance-properties.png)
...
![component is selected and the cursor is hovering above the create component icon.](/images/posts/v15/add-variant.png)

Select the card component and press on the **Add variant** icon at the top of the page.

![New variant is selected. Property 2 is renamed to hover and it is set to True.](/images/posts/v15/set-variant-property.png)
...
![default variant is selected and its hover property is set to False](/images/posts/v15/set-default-variant-property.png)
...
![another image was added to the stack increasing the width.](/images/posts/v15/duplicate-image.png)
...
![image on top of image stack is set to absolute position](/images/posts/v15/absolute-position-image.png)

To fix this and make it above them, give it an **absolute position** inside the "images frame".

![Image covering all image stack.](/images/posts/v15/fill-frame-image.png)

Then manually resize it to cover the whole "images frame".

![rectangle is selected. Fill is set to solid color with 21%](/images/posts/v15/change-image-to-solid-fill.png)
...
![hover variant toggled on and off](/images/posts/v15/figma-component-properties.png)
...
![icon frame is selected inside hover variant. x and y positions are both set to 16px.](/images/posts/v15/mstflotfy-design-figma-boolean-property.png)
...
![2 instances presented pointer above one of them shows hover effect](/images/posts/v15/figma-frame-presented.png)

Hover above our cards and you should see the hover effect.

It's a bit darker than the subtle effect we want.

![rectangle's (hover) opacity 6%](/images/posts/v15/mstflotfy-indieDev-adjust-hover-opacity-again.png)

Get back and reduce the opacity and check again. 

![2 image instances are presented, hovering above the first shows a very subtle change in color just like Pinterest.](/images/posts/v15/mstflotfy-indieDev-design-figma-present-frame.png)
...
![full Figma design page is shown with references, components, and frame to present.](/images/posts/v15/mstflotfy-indieDev-figma-design.png)
