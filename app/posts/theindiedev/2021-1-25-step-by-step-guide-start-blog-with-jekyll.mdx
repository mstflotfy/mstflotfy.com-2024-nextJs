...
date: "2021-01-25"
categories: ["dev"]
tags: ["blog", "markdown", "git"]
---

This article is a follow up to <CustomLink href="/dev/how-to-start-a-blog/">How To Start A Blog</CustomLink>, where I go through the reasons I choose <CustomLink href="https://jekyllrb.com/">Jekyll</CustomLink> and <CustomLink href="https://pages.github.com/">GitHub Pages</CustomLink> to build my blog and the other options I considered.
...
- <CustomLink href="/dev/command-line-very-beginner/">The Command-Line.</CustomLink>
- <CustomLink href="/dev/git-github-tutorial-very-beginner/">Git & GitHub.</CustomLink>
- `Jekyll. (This article is coming soon)`
- `Markdown. (This article is coming soon)`
