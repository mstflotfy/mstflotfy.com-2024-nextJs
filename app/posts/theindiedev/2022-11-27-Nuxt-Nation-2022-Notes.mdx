...
image: /images/posts/nuxt-nation-2022/nuxt-nation-2022-thumbnail.png
---
...
Some of the talks, that I took notes from can be found on the <CustomLink href="https://www.youtube.com/@vueschool3782/videos">Vue School YT channel</CustomLink>

There are <CustomLink href="https://nuxtnation.com/workshops">Free workshops</CustomLink> from Nuxt Nation, with limited seats.

## Nuxt 3.0 Stable {#nuxt-3-stable}

![Nuxt 2 vs Nuxt 3](/images/posts/nuxt-nation-2022/Nuxt3-vs-nuxt2.png)
...
![Nuxt 3 javaScript size vs Nuxt 2](/images/posts/nuxt-nation-2022/nuxt3-js-size-vs-nuxt2-js-size.png)

- Out of the 34.1KB, Vue is 25.3 and Nuxt is 8.7kB

![Nuxt 3 is fast, it has Hybrid rendering, and SEO and web vitals](/images/posts/nuxt-nation-2022/nuxt-3-features.png)
...
- <CustomLink href="https://michaelnthiessen.com/">Michael Thiessen</CustomLink>
...
<CustomLink href="https://v1.image.nuxtjs.org">https://v1.image.nuxtjs.org</CustomLink>
...
![defineModel code example](/images/posts/nuxt-nation-2022/defineModel.png)

![defineModel with reactivity transform code example](/images/posts/nuxt-nation-2022/defineModel-with-reactivity-transform.png)
...
<CustomLink href="https://nuxt.com/docs/guide/concepts/rendering/">Nuxt rendering docs</CustomLink>
...
<CustomLink href="https://v3.nuxtjs.org/api/advanced/kit">@nuxt/kit</CustomLink>
...
![As page load speed increases conversion rate decreases](/images/posts/nuxt-nation-2022/frontend-speed-conversion.png)
...
![Core web vitals: LCP (largest contentful paint), FID (first input delay), and CLS (cumulative layout shifts)](/images/posts/nuxt-nation-2022/LCP-FID-CLS.png)
...
![Simple to do app speed comparison across different front end frameworks](/images/posts/nuxt-nation-2022/todo-app-frontend-frameworks-speed-comparison.png)

![Complex app speeds comparison across different frontend frameworks](/images/posts/nuxt-nation-2022/complex-app-frontend-frameworks-speed-comparison.png)
...
![Different hosting providers (including cloudflare, netlify, and Vercel) that Nitro works with](/images/posts/nuxt-nation-2022/nitro-engine-toolbox.png)

## Comparing Nuxt 2 to Nuxt 3 {#nuxt3-vs-nuxt2}

- Now working with Vue3 instead of Vue2

![Vue 3 main features; increased performance, TypeSCript support, and it works with composition API](/images/posts/nuxt-nation-2022/nuxt-best-features.png)

- Adding more features to Universal Rendering

![Nuxt 3 has better performance, improved SEO, and allows for fast static site generation](/images/posts/nuxt-nation-2022/nuxt3-universal-rendering-improvements.png)

![Nuxt 3 runs anywhere, built for fast cold starts, and supports hybrid rendering](/images/posts/nuxt-nation-2022/Nuxt-3-universal-rendering.png)

<CustomLink href="https://vueschool.io/articles/vuejs-tutorials/hybrid-rendering-in-nuxt-js-3/">Hybrid Rendering in Nuxt.js 3</CustomLink>

![Zero-config Nuxt deploys on different platforms including Cloudflare pages, Vercel, and Netlify](/images/posts/nuxt-nation-2022/Nuxt-3-zero-config.png)

![Nuxt 2 used Webpack and CLI tooling](/images/posts/nuxt-nation-2022/nuxt-tooling.png)

![Nuxt 3 supports Vite and Nuxi CLI tooling](/images/posts/nuxt-nation-2022/nuxt3-tooling.png)
...
![Nuxt 3 components directory](/images/posts/nuxt-nation-2022/nuxt-components-directory.png)

- `/layouts` directory
	- extract common UI or code patterns into reusable layouts

![Nuxt 3 render page must be wrapped and uses slot element](/images/posts/nuxt-nation-2022/nuxt-slot.png)
- `/middleware`
...
- Unexplored - only a few usage examples out there, e.g.:
	- <CustomLink href="https://github.com/nuxt-thems/docus">Docus</CustomLink>
	- <CustomLink href="https://github.com/nuxt-themes/typography">Typography</CustomLink>
	- <CustomLink href="https://github.com/Antiux/content-wind">Content wind</CustomLink>
	- <CustomLink href="https://github.com/nuxt/framework/tree/main/examples/advanced/config-extends">config-extends</CustomLink>
...
- <CustomLink href="http://ionic.link/3f385om">Presentation Link</CustomLink>
- <CustomLink href="https://github.com/ceceliacreates/nuxt-ionic-demo/blob/main/pages/index.vue">Demo repo</CustomLink>
...
<CustomLink href="https://github.com/ceceliacreates/nuxt-ionic-demo/blob/main/pages/index.vue">Check the demo's GitHub repo</CustomLink>
...
### Ionic Resources
- <CustomLink href="https://www.google.com/url?q=https://ionic.nuxtjs.org/&sa=D&source=editors&ust=1669058207636519&usg=AOvVaw1G_pQoGJq3oazJEuOHsXwq">Nuxt/Ionic Docs</CustomLink>
- <CustomLink href="https://www.google.com/url?q=https://stackblitz.com/github/nuxt-modules/ionic/tree/main/playground&sa=D&source=editors&ust=1669058207636944&usg=AOvVaw1ezUaZYL35YRvYBwMBG-81">Nuxt/Ionic playground</CustomLink>
- <CustomLink href="https://www.google.com/url?q=https://github.com/nuxt-modules/ionic&sa=D&source=editors&ust=1669058207637173&usg=AOvVaw19YFKEZ0mpCBjyqxnV2NPT">Nuxt/Ionic GitHub</CustomLink>
- <CustomLink href="https://www.google.com/url?q=https://ionic.io/docs&sa=D&source=editors&ust=1669058207637335&usg=AOvVaw1hSpn_yqDy8I0NLqeU776Y">Ionic Docs</CustomLink>
- <CustomLink href="https://www.google.com/url?q=https://capacitorjs.com/docs&sa=D&source=editors&ust=1669058207637491&usg=AOvVaw1_DZYalBcYIlb581V8opsS">Capacitor Docs</CustomLink>
- <CustomLink href="https://www.google.com/url?q=https://ionic.io/docs/appflow&sa=D&source=editors&ust=1669058207637621&usg=AOvVaw3FKx0An7w6xblgmlHfiWky">Appflow Docs</CustomLink>
- <CustomLink href="https://www.google.com/url?q=https://github.com/ceceliacreates/nuxt-ionic-demo&sa=D&source=editors&ust=1669058207637749&usg=AOvVaw00tA1eJL7Mz0w__6if2lcz">Nuxt/Ionic Simple Demo App GitHub Repo</CustomLink>
- <CustomLink href="https://www.google.com/url?q=http://ionic.link/discord&sa=D&source=editors&ust=1669058207637878&usg=AOvVaw03kMRAQ4ZHuVzalXvoQEBW">Ionic Discord</CustomLink>
...
![Jumbo adding Vue to the stack](/images/posts/nuxt-nation-2022/jumbo-stack-vue.png)
...
So they build a component library.
 ...
 ![Jumbo using Vue, CMS, and component library to handle apps](/images/posts/nuxt-nation-2022/jumbo-stack-vue-cms-components.png)

![Jumbo added nuxt to the stack](/images/posts/nuxt-nation-2022/jumbo-stack-nuxt-vue-cms-components.png) 
...
![Component library pointing to CMS](/images/posts/nuxt-nation-2022/jumbo-workflow.png)

![Headless CMS connected to the adapter. An adapter is connected to the content service. And Content service connected to a database.](/images/posts/nuxt-nation-2022/jumbo-workflow-cms.png)

![customer with an arrow pointed to nuxt. Nuxt pointed to CMS. And CMS pointing to database](/images/posts/nuxt-nation-2022/jumbo-stack-nuxt.png)
...
<CustomLink href="https://github.com/Tahul/pinceau">piceau</CustomLink>
...
- <CustomLink href="https://trpc-nuxt.vercel.app/">trpc-nuxt.vercel.app</CustomLink>
- <CustomLink href="https://github.com/wobsoriano/trpc-nuxt">trpc-nuct github</CustomLink>
- <CustomLink href="https://trpc.io/docs">trpc docs</CustomLink>
...
Resources
- <CustomLink href="https://www.youtube.com/playlist?list=PLi-X1Ojrrmi8hTTHRs2LprNaaZBDY5Mhk">ThreeJs playlist</CustomLink>
- <CustomLink href="https://threejs-journey.com/#">ThreeJS Journey by Bruno Simon</CustomLink>
...
## <CustomLink href="https://unjs.io">UNJS</CustomLink> and Nuxt 3 {#unjs-nuxt3}

<CustomLink href="https://docs.google.com/presentation/d/1li7HfYo1ZTEnFCdpZuSO1k2ba5V7piGKat9NV_ryLVY/edit#slide=id.p">Presentation link</CustomLink>
...
<CustomLink href="htttps://github.com/unjs/unbuild">unjs/unbuild</CustomLink>

Made for building Nuxt 3 modules and packages

<CustomLink href="htttps://github.com/unjs/changelogen">unjs/changelogen</CustomLink>

Beautiful change logs using conventional commits
Used for Nuxt 3 releases notes and change-logs

<CustomLink href="https://github.com/unjs/unplugin">unjs/unplugin</CustomLink>
Unified plugin system for Vite, Rollup, Webpack, and more.

<CustomLink href="https://github.com/unjs/unimport">unjs/unimport</CustomLink>
A system that makes imports automated. Smartly tree shaken. ...

<CustomLink href="https://github.com/unjs/ofetch">unjs/ofetch</CustomLink>

Better fetchAPI natively works on node, browsers, and workers.
Provides universal `$fetch` for Nuxt 3.

<CustomLink href="https://github.com/unjs/node-fetch-native">node-fetch-native</CustomLink>
If you have a custom server or nodejs project. Future proof. Supports native fetch implementations for the server.

<CustomLink href="https://github.com/unjs/h3">unjs/h3</CustomLink>
...
<CustomLink href="https://github.com/unjs/unstorage">unjs/unstorage</CustomLink>
...
### <CustomLink href="https://github.com/unjs/listhen">unjs/listhen</CustomLink>
- Elegant HTTP listener.
- Powering Nuxi CLI
- Small package with one single purpose to listen

### <CustomLink href="https://github.com/unjs/c12">unjs/c12</CustomLink>
- Smart configuration loader.
- Powering Nuxt 3 and Nitro with extends and theming support.

### <CustomLink href="https://github.com/unjs/ipx">unjs/ipx</CustomLink>
...
### <CustomLink href="https://github.com/unjs/untyped">unjs/untyped</CustomLink>
...
### <CustomLink href="htttps://github.com/unjs/giget">unjs/giget</CustomLink>
- Download templates and git repos
- Powering nuxi init

### <CustomLink href="https://nitro.unjs.io">unjs/nitro</CustomLink>
...
<CustomLink href="https://github.com/Baroshem/headless-avuengers">Example app using Storyblok and Algolia with Nuxt</CustomLink>
...
## <CustomLink href="https://nuxt-security.vercel.app">Nuxt Security</CustomLink> {#nuxt-security}
...
![reactive getter code example](/images/posts/nuxt-nation-2022/nuxt-reactive-getter-support.png)
- Array support
- Prop promises
- DOM event handlers
...
![useSeoMeta code example](/images/posts/nuxt-nation-2022/useSeoMeta.png)

![Nuxt-unhead get early access to experimental features at github.com/harlan-zw/nuxt-unhead](/images/posts/nuxt-nation-2022/nuxt-unhead-experimantal.png)
...
If you want to start a new project. It's recommended to go to <CustomLink href="https://nuxt.new">nuxt.new</CustomLink>
There are a couple of templates there, but some interesting things are coming soon.

<CustomLink href="https://nuxt.com/docs/getting-started/installation">You can follow the Nuxt official installation Docs</CustomLink>
...
![Posts/Landing page with a list of posts and a link to each](/images/posts/nuxt-nation-2022/nuxt-blog-posts.png)
...
Here's the result when clicking on a post.
 ...
 ![Post page with a title and body and a "Back Home" button](/images/posts/nuxt-nation-2022/nuxt-blog-post.png)

![404 page with "Post not found" text](/images/posts/nuxt-nation-2022/404-nuxt-page.png)
...
![.netlify folder prepared for deploying to Netlify](/images/posts/nuxt-nation-2022/deploy-nuxt-to-netlify-directory.png)
...
- <CustomLink href="https://docus.dev/">Docus</CustomLink> -- Create your own Docs with Nuxt.
- Nuxt typography
- Nuxt Studio (still in Beta)
- <CustomLink href="https://www.vuetelescope.com/">Vuetelescope.com</CustomLink>
- <CustomLink href="https://sidebase.io/">sidebase.io</CustomLink> -- An auth module
- <CustomLink href="https://github.com/nuxt/module-builder">Nuxt (3) Module Builder</CustomLink>
- <CustomLink href="https://vuestorefront.io/">Vue storefronts</CustomLink>
- <CustomLink href="https://strapi.io">Strapi</CustomLink>