...
date: "2022-11-27"
categories: ['dev']
tags: ['vsc', 'nuxtjs', 'solved']
image: /images/posts/vsc-wont-update-on-mac/vsc-check-for-updates.png
---
...
![VSCode settings icon clicked. A menu pops up with a "check for updates..." option, that is about to be clicked](/images/posts/vsc-wont-update-on-mac/vsc-check-for-updates.png)
...
I was directed to <CustomLink href="https://github.com/microsoft/vscode/issues/7426#issuecomment-425093469">this post</CustomLink>

![The link states that it's due to a well-known Squirell issue. And the workaround is to move the VSC app from the downloads to the Applications folder or run the code below](/images/posts/vsc-wont-update-on-mac/cannot-update-vscode-link.png)

I found others with the same problem on <CustomLink href="https://github.com/Squirrel/Squirrel.Mac/issues/182">this thread</CustomLink>. Some people on this thread said that moving the VSC app out of the Apps folder and back again worked for them. Every time I tried to do that, the App did not move but created a shortcut.
...
![Volar(Vue Language Features) installed and enabled in VSC](/images/posts/vsc-wont-update-on-mac/volar-installed-vsc.png)

P.S. You might need to disable Vetur to stop conflicts between it and Volar.

![Vetur disabled in VSCode](/images/posts/vsc-wont-update-on-mac/vetur-disabled-vsc.png)