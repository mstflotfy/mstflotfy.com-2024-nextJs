...
image: /images/posts/v14/what's_new_in_figma.png
date: "2022-05-23"
categories: ['design']
tags: ['figma', 'tutorial']
---
...
## Intro 
![what's new in Figma at Figma config 2022](/images/posts/v14/what's_new_in_figma.png)
...
Here's <CustomLink href="https://www.figma.com/community/file/1111642615512042772">a link to the Figma community file</CustomLink> used in this article.

## Dark Mode

![Dark mode in Figma came to Figma](/images/posts/v14/dark_mode.png)

We'll start by opening a new design file. 

![Create a new design file in Figma](/images/posts/v14/new_file.png)
...
![Use the quick access menu to toggle dark mode](/images/posts/v14/quick_dark.png)

![change canvas background color](/images/posts/v14/dark_background.png)

## Variable Fonts 

![Now you can use Variable fonts in Figma](/images/posts/v14/variable_fonts.png)
...
![Create a text box](/images/posts/v14/button.png)
...
If you want to read more on variable fonts, check out this <CustomLink href="https://web.dev/variable-fonts/">Introduction to variable fonts on the web</CustomLink> article. 
...
![Adjust variable fonts inside your Figma design](/images/posts/v14/adjust_font.png)

## Auto Layout Text Baseline Alignment 
...
![Frame the icons to use with our auto-layout button](/images/posts/v14/buttons_icons.png)
...
![auto layout text baseline alignment example](/images/posts/v14/Pasted%20image%2020220521205639.png)

## Auto Layout Visual Alignment 
Auto-layout now has visual alignment added to it. So we can visually adjust the padding and the spacing between items.

![You can now align elements visually inside auto-layout frames in Figma](/images/posts/v14/Pasted%20image%2020220521205806.png)
...
![How to add individual strokes to your elements in Figma](/images/posts/v14/Pasted%20image%2020220521210229.png)

We've covered a lot of updates, but now let's move to the big one.

## Component Properties

![component properties in Figma](/images/posts/v14/Pasted%20image%2020220521234327.png)

Select our button frame, and turn it into a component by pressing the "Create component" button, at the top of the page.

![Create a button component in Figma](/images/posts/v14/Pasted%20image%2020220521234018.png)
...
![How to create a text component property in Figma](/images/posts/v14/Pasted%20image%2020220521235311.png)
...
![Create an instance of your button component](/images/posts/v14/Pasted%20image%2020220521235617.png)
...
![Update your text using text component property](/images/posts/v14/Pasted%20image%2020220521235836.png)
...
![Add a nested auto-layout frame to your component](/images/posts/v14/Pasted%20image%2020220522000631.png)
...
![Remove component property](/images/posts/v14/Pasted%20image%2020220522000854.png)

![Add a new text component property](/images/posts/v14/Pasted%20image%2020220522001011.png)

Now, if you select our instance you'll have 2 options, Text and Secondary_text. So set a custom secondary_text.

![Update your button's text using text component properties](/images/posts/v14/Pasted%20image%2020220522001159.png)

Now that we have 2 text boxes, text baseline alignment is not ideal, so remove it and align to center instead.

![Remove text baseline alignment](/images/posts/v14/Pasted%20image%2020220522001321.png)
...
![How to add a boolean property in Figma](/images/posts/v14/Pasted%20image%2020220522001708.png)
...
![Toggle an icon on and off using boolean properties in Figma](/images/posts/v14/Pasted%20image%2020220522002235.png)
...
![Add a boolean property to your button](/images/posts/v14/Pasted%20image%2020220522104457.png)
...
![Toggle layer using a boolean property](/images/posts/v14/Pasted%20image%2020220522105434.png)
...
![Apply an instance swap property](/images/posts/v14/Pasted%20image%2020220522112119.png)
...
![Swap between components using an instance swap property](/images/posts/v14/Pasted%20image%2020220522112417.png)
...
![How to add a new variant in Figma after the update](/images/posts/v14/Pasted%20image%2020220522120759.png)

![Add a new variant](/images/posts/v14/Pasted%20image%2020220522120901.png)
...
![Change variant's property name and value](/images/posts/v14/Pasted%20image%2020220522121015.png)
...
![How to add a hover variant in Figma](/images/posts/v14/Pasted%20image%2020220522131157.png)
...
![Toggle between your variants](/images/posts/v14/Pasted%20image%2020220522131405.png)

![Switch between your Figma variants](/images/posts/v14/Pasted%20image%2020220522131433.png)
...
![Use interactive components to create a hover effect](/images/posts/v14/Pasted%20image%2020220522132022.png)

To present the design and try out the prototype. Select the "Instances" frame, give it a fill, then press the present button.

![Present your frame in Figma](/images/posts/v14/Pasted%20image%2020220522134650.png)

Now you can hover above all the buttons and see the hover effect in action.

![button hover prototype in Figma](/images/posts/v14/Pasted%20image%2020220522134806.png)

Now let's look at some of the other new Figma updates, that we didn't cover in our example.


## Auto Layout Negative Spacing
...
![Using the new auto-layout negative spacing to recreate Pinterest's pins stack](/images/posts/v14/Pasted%20image%2020220522141144.png)
...
![Figma's auto-layout negative spacing practical example](/images/posts/v14/Pasted%20image%2020220522142032.png)

The order of the stack can be reversed, by going to "Advanced layout settings" and setting "Canvas stacking" to "First on top".

![Using canvas stacking in Figma](/images/posts/v14/Pasted%20image%2020220522143750.png)
...
![Discovered a Figma negative stacking bug](/images/posts/v14/Pasted%20image%2020220522143506.png)


## Spring Animation

![Introduction to Spring Animations In Figma](/images/posts/v14/Pasted%20image%2020220522145434.png)
...
![Add a new variant and name its property](/images/posts/v14/Pasted%20image%2020220522162900.png)
...
![Set a spring animation in Figma](/images/posts/v14/Pasted%20image%2020220522163538.png)
...
![Change the size and color of the variant for the spring animation to take place](/images/posts/v14/Pasted%20image%2020220522164609.png)
...
![present frame to check the spring animation](/images/posts/v14/Pasted%20image%2020220522164930.png)
...
![Make a delayed animation in Figma](/images/posts/v14/Pasted%20image%2020220522201628.png)

Present the frame and click try it one more time.

![Present your design](/images/posts/v14/Pasted%20image%2020220522201939.png)

Check the prototype it should change to clicked=True, then after a short delay, change back to clicked=False.

![spring animation with a delay](/images/posts/v14/spring_animation.gif)
...
![Add a file to your Favorites list in Figma's Drafts folder](/images/posts/v14/Pasted%20image%2020220522221057.png)

You can also add a file to your Favorites while you're inside the file.

![add a file to Favorites](/images/posts/v14/Pasted%20image%2020220522221239.png)

---

This is it. These are the updates I found most impactful and for a full official list check <CustomLink href="https://www.figma.com/whats-new/">this page</CustomLink>. You can also check the free Figma community file with the examples in this article. 
