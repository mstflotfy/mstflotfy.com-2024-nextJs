...
image: /images/posts/v18/fab-thumbnail-3.png
date: "2023-01-27"
categories: ['design']
tags: ['figma', 'fab', 'materialdesign', 'OneExercise', 'app-design']
---
...
The second part of the vid is a step-by-step tutorial of how I used <CustomLink href="https://www.figma.com/community/file/1035203688168086460">Material 3 design kit</CustomLink> in Figma to add a custom FAB in the design of my app and I make a mini prototype to present and test it.

You can watch the vid above or you can read this summary.

## <CustomLink href="https://youtube.com/shorts/DtSv3_A4DqQ?feature=share">What is Material Design?</CustomLink>

Material Design is Google's open-source design system, and Material Design 3 is the latest version of it. 

The website <CustomLink href="https://m3.material.io">m3.material.io</CustomLink> includes guidelines on using the Material design system to design for Android and the web.
...
If you check the <CustomLink href="https://m3.material.io/components/floating-action-button/overview">FAB</CustomLink>, and <CustomLink href="https://m3.material.io/components/extended-fab/overview">extended FAB</CustomLink> guideline pages on the material design website you'll find more guidelines and very specific info on how to use the FAB and how not to use it as well. 

![Foundations page from the m3.material.ion website](/images/posts/v18/Pasted%20image%2020230127230659.png)
...
![Google Keep app using a FAB](/images/posts/v18/Pasted%20image%2020230126233114.png)

And Gmail has an extended FAB to quickly compose a new email. 

![Gmail using an extended FAB](/images/posts/v18/Pasted%20image%2020230126233245.png)

## How I used a FAB in my App's Design

While wireframing this is how I imagined the FAB. 

![Hand-drawn Wire frame of my app with FAB](/images/posts/v18/Pasted%20image%2020230126232349.png)

I wanted a main FAB and when I click it 2 other FABs would come app. 

![FAB from my wireframe drawn in Goonotes on the iPad](/images/posts/v18/Pasted%20image%2020230126232445.png)
...
![Wireframe for my app clicked](/images/posts/v18/Pasted%20image%2020230126232516.png)

Clicking on a FAB that opens a list of FAB is inspired by MyNetDiary an app I'm currently using to track my calories.

![FAB from MyNetDiary app](/images/posts/v18/Pasted%20image%2020230126232637.png)

So my first attempt to implement this in Figma using the Material 3 kit. This is what you see in the image below.

![FAB from the design of my app in Figma](/images/posts/v18/Pasted%20image%2020230126232737.png)
...
![Extended FAB from the design of my app in Figma](/images/posts/v18/Pasted%20image%2020230126232826.png)
...
![2 extended FAB in the design of my app using Material 3 components](/images/posts/v18/Pasted%20image%2020230126232847.png)



## A step-by-step guide to adding an interactive FAB to your design

<CustomLink href="https://www.youtube.com/watch?v=asN3B33wOzo&t=321s">05:21</CustomLink> -- You can go to this part of the vid.

###  1. Get a copy of the free <CustomLink href="https://www.figma.com/community/file/1035203688168086460">Material 3 Design Kit Figma Community File</CustomLink>
...
![Material 3 design kit in figma](/images/posts/v18/Pasted%20image%2020230126214510.png)
...
![Crating a large android device frame in Figma](/images/posts/v18/Pasted%20image%2020230126231027.png)
...
![Adding a device inside a frame in Figma](/images/posts/v18/Pasted%20image%2020230126223410.png)
...
![Making prototype connections to the material 3 component in Figma](/images/posts/v18/Pasted%20image%2020230126223620.png)

Then just grab a copy of the primary FAB and drop it into our design page to take an instance of it.
![Extended FAB dropped into our design frame](/images/posts/v18/Pasted%20image%2020230126223728.png)

### 5.  Edit the Label and Icon of the FAB


![Zoomed in on the extended FAB and edited it](/images/posts/v18/Pasted%20image%2020230126223826.png)

### 6. Test the FAB's hover and press states

First turn it into a component, as we'll add a variant to it soon.

![Mouse hovering above the "Create component" button while the FAB instance is selected](/images/posts/v18/Pasted%20image%2020230126223944.png)

Then grab a copy of it and drop it inside our device frame.

![An instance of our custom FAB component placed inside the frame of our design](/images/posts/v18/Pasted%20image%2020230126224159.png)

Present it, hover it, and press on it.

![Presenting the design and pressing on the FAB and it changes to the pressed state](/images/posts/v18/Pasted%20image%2020230126224234.png)

### 7. Add an open-state variant

Add a new variant to our extended FAB.

![FAB custom component selected and mouse about click the "Add variant" button](/images/posts/v18/Pasted%20image%2020230126224309.png)

The new variant is 2 FABs on top of each other. 

![Open state with 2 FABs ](/images/posts/v18/Pasted%20image%2020230126224455.png)

For the Add button to change to its open state, we'll use an overlay. 

![The enabled state of our custom FAB connected to an overlay](/images/posts/v18/Pasted%20image%2020230126224702.png)

An overlay is going to open right on top of the Add FAB and cover it. 

![](/images/posts/v18/Pasted%20image%2020230126224750.png)
...
![The overlay placed right on top of the FAB](/images/posts/v18/Pasted%20image%2020230126224809.png)

You can now present our design and see the FAB in action.

![FAB is in an open stated and hovering mouse hovering above the create workout button](/images/posts/v18/Pasted%20image%2020230126224848.png)

Finally, you can add a couple of pages with back buttons, so you can have a mini prototype.

![Couple of new pages added and adding an on tap back](/images/posts/v18/Pasted%20image%2020230126224952.png)


## Links 
- <CustomLink href="https://www.figma.com/community/file/1195342405127749072">A free Figma Community File (FAB Prototype (material design 3 component</CustomLink> 
- <CustomLink href="https://www.figma.com/community/file/1035203688168086460">Material 3 design kit</CustomLink>
- <CustomLink href="https://m3.material.io/">Material design 3 website</CustomLink> 
- <CustomLink href="https://m3.material.io/components/floating-action-button/overview">FAB component Material 3 Guide</CustomLink> 
- <CustomLink href="https://m3.material.io/components/extended-fab/overview">FAB component Material 3 Guide</CustomLink> 
