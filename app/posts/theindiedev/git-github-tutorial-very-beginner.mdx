...
image: /images/posts/gitDoodle.png
date: "2021-03-09"
categories: ['dev']
tags: ['tutorial', 'git', 'github', 'beginner']
---


Git and GitHub are necessary skills to create your Jekyll website and add content to it. This article is part of <CustomLink href="/dev/step-by-step-guide-start-blog-with-jekyll/">A Step By Step Guide To Start A Blog With Jekyll.</CustomLink> Here is the full list of skills you need to get familiar with before starting the step by step guide:

1. <CustomLink href="/dev/command-line-very-beginner/">The Command-Line.</CustomLink>
2. **Git & GitHub** 
3. `Markdown. (This post is coming soon)`
4. `Jekyll. (This post is coming soon)`

## **Why learn Git?**

**To host your website for free on <CustomLink href="https://pages.github.com/">GitHub Pages</CustomLink>.** You need to learn how to use Git locally (on your computer), then to push (upload) your work to GitHub, which will then bring the changes you made locally to your website. Later on, making changes to your website will not take much effort. You will have a simple workflow--you will open your text editor, make changes, then use a couple of short terminal commands, and these changes will go live.
...
Git is a command-line tool. Therefore **this tutorial is dependent on understanding the command line basics.** If you have not already, go through <CustomLink href="/dev/command-line-very-beginner">the command line tutorial for the very beginner</CustomLink> before you start. Otherwise, you will feel lost. If you're already familiar with the command line, you can <CustomLink href="/dev/command-line-cheat-sheet/">refer to the command line cheat sheet</CustomLink> if you need to.
...
1. Install Git.
    ...
    If Git is not installed, <CustomLink href="https://git-scm.com/downloads">download and install it</CustomLink>.
...
3. Create a GitHub account.
    ...
    Finally, <CustomLink href="https://github.com/join">Create a GitHub account.</CustomLink>
    ...
    To create a personal access token, follow <CustomLink href="https://docs.github.com/en/github/authenticating-to-github/creating-a-personal-access-token#creating-a-token">this short and easy guide by GitHub.</CustomLink>. You'll be presented with multiple checkboxes. It's enough to tick the repo box.


### Start working with git Locally
...
1. **Create a new empty GitHub repo**
    ...
    <CustomLink href="https://guides.github.com/activities/hello-world/#repository">Follow the `Create a repository` part in this guide by GitHub.</CustomLink>
...
1. **Make a commit in your remote GitHub repo**
    ...
    Go to your GitHub repo. You'll find all the files you've committed locally and pushed. Click on one of the files and follow the <CustomLink href="https://guides.github.com/activities/hello-world/#commit">Make a commit section in this GitHub Guide</CustomLink>
...
1. Fork a repo
    ...
    If you don't have a repo you want to fork. You can fork the repository of my <CustomLink href="https://github.com/mstflotfy/mstflotfy.github.io">Jekyll website.</CustomLink>


2. Turn your fork into a template

    Go to the settings of the repository. Under the repository check the `Template repository` checkbox. You can follow <CustomLink href="https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/creating-a-template-repository">this guide by GitHub</CustomLink>.


3. Create a new repo from the template

    Go to the main page of the repo, by clicking on its name, or on the `< > code` button. Then click on the green button `Use this template`. Then, it's like creating a new repository. <CustomLink href="https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/creating-a-repository-from-a-template#creating-a-repository-from-a-template">More on this.</CustomLink>
...
<CustomLink href="https://guides.github.com/">GitHub Official Guides</CustomLink>
<CustomLink href="https://www.git-scm.com/book/en/v2/Git-Basics-Getting-a-Git-Repository#ch02-git-basics-chapter">Pro Git Book</CustomLink> 
<CustomLink href="https://www.freecodecamp.org/news/what-is-git-and-how-to-use-it-c341b049ae61/">A step by step intro to Git</CustomLink> 
<CustomLink href="https://www.youtube.com/watch?v=USjZcfj8yxE">A quick youtube video that shows the git workflow</CustomLink> 
<CustomLink href="https://www.youtube.com/watch?v=nhNq2kIvi9s">Youtube video explaining the workflow between git and gitHub</CustomLink>
<CustomLink href="https://www.youtube.com/watch?v=HVsySz-h9r4">Youtube video explaining git and showing workflow</CustomLink>
<CustomLink href="https://www.atlassian.com/git/tutorials/learn-git-with-bitbucket-cloud">Bitbucket Git Tutorials</CustomLink>



Back: [The Command Line Cheat Sheet](/dev/command-line-cheat-sheet/) | Next: [A git cheat sheet](/dev/git-cheat-sheet/)
