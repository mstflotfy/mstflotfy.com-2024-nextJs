...
image: /images/posts/v13/v13-Th.png
date: "2022-05-07"
categories: ['design']
tags: ['figma', 'tutorial']
---

Whatever the design you're working on, it will (most probably) have a **dropdown menu** somewhere. So, in this article, I'll attempt to simplify making a dropdown menu in Figma. As a part of my <CustomLink href="https://www.youtube.com/playlist?list=PLsOexrcoU3Q4b-dI6chgagDntDD-AgetO">Pinterest Clone in Figma</CustomLink> exercise.

We'll use auto-layout, components, and variants. We'll create a prototype using <CustomLink href="https://help.figma.com/hc/en-us/articles/360061175334#Before">**interactive components**</CustomLink>.
...
![Starting point in the Figma community file](/images/posts/v13/startingPoint.png)

I've already been working on a **Pinterest Clone in Figma**. I started from scratch and created a design for the home page. I even made the <CustomLink href="https://www.youtube.com/watch?v=3KUZ3o0ddcE&list=PLsOexrcoU3Q4b-dI6chgagDntDD-AgetO&index=5&t=379s">homepage design fully responsive with breaking points</CustomLink>. 
...
![All the components of the design at its starting point](/images/posts/v13/allComponents.png)
...
Inside the <CustomLink href="https://www.figma.com/community/file/1104788393847411628">file</CustomLink>:

We have a screenshot, just as a reference. 

![Screenshot of Pinterest's dropdown menu](/images/posts/v13/screenshots.png)

Then we have the design frame, which we'll not do anything to. We'll only use it to present our prototype. 

![The frame holding the design, present it to try the prototype](/images/posts/v13/designFrame.png)
...
![Starting components](/images/posts/v13/currentComponents.png)
...
![Header component](/images/posts/v13/header.png)

If you're unfamiliar with components, you can check the "<CustomLink href="https://www.youtube.com/playlist?list=PLsOexrcoU3Q4b-dI6chgagDntDD-AgetO">Pinterest clone in Figma</CustomLink>" playlist and it will get you familiar with it, another option is to watch "<CustomLink href="https://www.youtube.com/watch?v=euXzyxr_d6A">How I used Figma to create a full design and prototype for my website</CustomLink>". 
...
![Dropdown button component](/images/posts/v13/dropdownComp.png)
...
![Profile image component](/images/posts/v13/profileImageComp.png)

Now let's get to it, and start making the dropdown menu.

To follow along I made <CustomLink href="https://www.figma.com/community/file/1104788393847411628">a Figma community file</CustomLink>. Open the link while you're signed in to your Figma account, press on duplicate at the top right side of the page, and you'll have a copy of it in your drafts folder.
...
![Dropdown button default and hover variants](/images/posts/v13/hoverVariant.png)
...
![Drop down button hover connection](/images/posts/v13/hoverProto.png)
- Select the Design frame and present it to try it out.

![dropdown button's hover state presented](/images/posts/v13/hover.png)
...
![The menu item component with all its variants](/images/posts/v13/menuItemsVariants.png)
...
![Create the menu item component, starting with a text variant](/images/posts/v13/titleVariant.png)
...
![Add a text variant](/images/posts/v13/textVariant.png)
...
![Add a text, hover variant](/images/posts/v13/textHoverVariant.png)
...
![Create a text & link icon variant](/images/posts/v13/textLink.png)
...
![Create a text & link icon Hover Variant](/images/posts/v13/textLinkHoverVariant.png)
...
![Add another variant for the user item](/images/posts/v13/usrV.png)
...
![Add the last variant: User Hover State](/images/posts/v13/usrHv.png)
...
![The three drop-down button variants](/images/posts/v13/dropdownVariants.png)

### Create the open variant

![The dropdown button open variant](/images/posts/v13/openVariant.png)
...
![Dropdown button variant connections](/images/posts/v13/openConnections.png)
...
![Three dropdown button variants for its three states](/images/posts/v13/dropdownVariants.png)
...
![The dropdown menu variant](/images/posts/v13/DropdownMenu.png)
...
![The Figma file after making the dropdown menu](/images/posts/v13/done.png)
...
![Dropdown menu in action](/images/posts/v13/donePresented.png)
